...
jQuery(document).ready(function () {
		...
		// Share Counter START
		var current_url = 'https://play.google.com/store/apps/details?id=com.practicality.allinyourhandsandroid';
		...
		jQuery( 'body' ).on( "pagechange", function( event, ui ) {
			...
			// Share Counter START
			var current_url = 'https://play.google.com/store/apps/details?id=com.practicality.allinyourhandsandroid';//document.location.href;
		...
		var disqus_shortname = 'All In Your Hands'; // Required - Replace example with your forum shortname
