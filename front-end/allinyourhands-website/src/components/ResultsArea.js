...
import { UndoVariant, ChevronDown } from 'mdi-material-ui'
          ...
          this.props.targetContentDetailed === false ?
            (                                             /* LISTA DE RESULTADOS */
              <React.Fragment>
                ...
                {this.props.books.length > 0 || this.props.places.length > 0 || this.props.allContents.length > 0 ?
                  (
                    <center>
                      <Button color="primary" className={classes.button} onClick={() => this.props.moreContentsAction()}>
                          Mais Conteudos <ChevronDown />
                      </Button>
                    </center>
